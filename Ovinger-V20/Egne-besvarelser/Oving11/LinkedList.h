...
// Rekker dessverre ikke å implementere som templates, men det ser vel bare ut som insert(), find() og void remove() eksplisitt krever string
// Løsningen ville vært å omskrevet på samme måte som i task4.h. Usikker på hvilke datatyper det begrenses til, vi bruker jo (==) i find, 
